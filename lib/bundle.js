          ...
          _this2.blocks.forEach(function (block, idx) {
            ...
            if (block.health <= 0) {
              if (block.health <= 0 && block.powerUp === true) {
                _this2.panda2.powerInitiate(0.1);
                _this2.panda3.powerInitiate(-0.1);
              }
...
var Panda = function () {
  ...
  _createClass(Panda, [{
    ...
    key: 'powerInitiate',
    value: function powerInitiate(x) {
    ...
    value: function bounce(bamboo) {
      ...
      if (this.panda.y + this.dy > 542) {
        ...
        if (this.panda.x > bamboo.bamboo.x && this.panda.x < bamboo.bamboo.x + 28 || disX < 20 && disY < 5) {
          ...
          {
            console.log(this.panda.id, this.panda.x, disX);
            this.dy = -this.dy;
            if (this.dx + 2 < 5) {
              this.dx += 2;
            }
