    ...
    value: function play(e) {
      ...
      if (e.keyCode === 32) {
        ...
        this.ticker.addEventListener("tick", function () {
          ...
          _this2.panda.bounce(_this2.bamboo);
          _this2.stage.update();
    ...
    value: function createBlocks(posX, posY, width, height) {
      ...
      for (var col = 0; col < 5; col++) {
        ...
        for (var row = 0; row < 15; row++) {
          this.blocks[count] = new _blocks2.default(this, 1, posX, posY);
...
var Panda = function () {
  ...
  _createClass(Panda, [{
    ...
    value: function blockBounce(block) {
      var disX = Math.abs(this.panda.x - block.posX);
      var disY = Math.abs(this.panda.y - block.posY);
      if (this.panda.x > block.posX && this.panda.x < block.posX + 50 && this.panda.y > block.posY && this.panda.y < block.posY + 20 || disX > 0 && disX < 30 && disY < 30) {
        block.health -= 1;
        // this.dx = -this.dx;
        this.dy = -this.dy;
        if (block.health <= 0) {
...
var Block = function () {
  function Block(game, health, posX, posY) {
